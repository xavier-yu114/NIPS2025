...
# --- Configuration ---
input_filename = '/data/YUXUAN/Z_cot/OCR/Perception/OCR_Perception_convert_part5.json'  # <<< CHANGE THIS to your actual input file name
output_filename_1 = '/data/YUXUAN/Z_cot/OCR/Perception/OCR_Perception_convert_part5.json'  # File for the first 2000 objects
output_filename_2 = '/data/YUXUAN/Z_cot/OCR/Perception/OCR_Perception_convert_part6.json'  # File for the remaining objects
